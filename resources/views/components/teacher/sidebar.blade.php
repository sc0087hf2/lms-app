    ...
    <ul class="space-y-2 font-medium">
      ...
      <li>
        <details class="group">
          ...
          <ul class="space-y-2 mt-2 pl-6">
            <li><a href="{{ route('teacher.todos.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-300">ToDo一覧</a></li>
            <li><a href="{{ route('teacher.todos.create') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-300">ToDo追加</a></li>
          </ul>
        </details>
      </li>
      <li>
      ...
      <li>
        <details class="group">
          ...
          <ul class="space-y-2 mt-2 pl-6">
            <li><a href="{{ route('teacher.homework.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-300">宿題一覧</a></li>
