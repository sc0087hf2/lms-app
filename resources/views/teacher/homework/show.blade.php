  ...
  <section class="text-gray-600 body-font">
      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">宿題詳細</span>
          </div>
        </li>
      </ol>
    </nav>
    <div class="container px-5 py-8 mx-auto">
      <div class="flex flex-col text-center w-full">
        <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">宿題　詳細</h1>
      </div>
          ...
          <div class="h-full p-8 relative">
            <table class="w-full">
              <tbody>
                <!-- 宿題 -->
                <tr class="">
                  <td class="w-48 border-b-4 border-yellow-500 pl-2 pb-6 pt-6 tracking-widest text-base sm:text-lg font-semibold text-gray-900">宿題</td>
                  <td class="w-144 border-b-4 border-gray-300 pl-4 pb-6 pt-6 text-base sm:text-lg text-gray-900">{{ $homework->homework }}</td>
                </tr>
                <!-- 次回授業日 -->
                <tr class="">
                  <td class="w-48 border-b-4 border-blue-500 pl-2 pb-6 pt-6 tracking-widest text-base sm:text-lg font-semibold text-gray-900">次回授業日</td>
                  <td class="w-144 border-b-4 border-gray-300 pl-4 pb-6 pt-6 text-base sm:text-lg text-gray-900">{{ \Carbon\Carbon::parse($lesson->next_lesson_date)->format('Y/n/j') }}</td>
                </tr>
                <!-- 次回授業内容 -->
                <tr class="">
                  <td class="w-48 border-b-4 border-blue-500 pl-2 pb-6 pt-6 tracking-widest text-base sm:text-lg font-semibold text-gray-900">宿題背景</td>
                  <td class="w-144 border-b-4 border-gray-300 pl-4 pb-6 pt-6 text-base sm:text-lg text-gray-900">{{ $todo->todo }}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <div class="flex flex-wrap -m-2">
              <div class="p-2 md:w-1/2 w-full">
                <div class="h-full flex items-center border-blue-900 border rounded-lg group hover:bg-blue-900 hover:border-white">
                  <button
                    onclick="location.href='{{ route('teacher.homework.edit', ['homeworkId' => $homework->id]) }}'"
              ...
              <div class="p-2 md:w-1/2 w-full">
                <form
                  action="{{ route('teacher.homework.destroy', ['homeworkId' => $homework->id]) }}"
                  method="POST"
