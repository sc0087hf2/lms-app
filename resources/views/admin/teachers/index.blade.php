      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">先生一覧</span>
          </div>
        </li>
      </ol>
    </nav>
    <div class="container px-5 py-8 mx-auto">
      ...
      <div class="w-full mx-auto">
        <table class="table-auto text-left whitespace-no-wrap">
          <thead>
            <tr>
              <th class="border-b-4 border-blue-900 px-4 py-3 w-64 sm:w-72 title-font tracking-wider text-black text-sm">名前</th>
          ...
          <tbody>
            ...
            <tr>
              <td class="border-b-2 border-dashed border-gray-200 px-4 py-6">{{ $teacher->user->last_name }}{{ $teacher->user->first_name }}</td>
              <td class="border-b-2 border-dashed border-gray-200 px-6">
                <form
                  action="{{ route('admin.teachers.destroy', ['teacherId' => $teacher->id]) }}"
                  method="POST"
