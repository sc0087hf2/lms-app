...
生徒の目標管理や学習進捗の管理、さらに授業や宿題として使えそうな教材を提供するアプリケーションです。生徒の学習効果を高め、授業を円滑に進めるために作成しました。

## 作成背景

私が家庭教師として担当している生徒に目的意識を持って行動するきっかけを提供したいという思いと、私自身の知識やスキルをアウトプットしたいという思いで、このアプリケーションを作成しました。
